...
class ModificarInventarioModal extends Component {
    state = {
        modal: false
    }
        ...
        return (
            <Fragment>
                ...
                <Modal isOpen={this.state.modal} toggle={this.toggle}>
                    ...
                    <ModalBody>
                        <ModificarInventario resetState={this.props.resetState} toggle={this.toggle} inventario={this.props.inventario}/>
                    </ModalBody>
                </Modal>
            </Fragment>
        )
